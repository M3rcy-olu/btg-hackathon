...
async def upload_file(file: UploadFile = File(...)): 
    """
    Right now I want to modify this function to take in a video url 
    - should check that the url leads to a valid video
    - should send video to an api that get transcripts of videos --> use whisper model openai api
    - should send back the transcript
    """
    #defining an async function mean app can handle other requests while waiting for this function to complete
    await send_status_update("Received file. Starting analysis...")
    #using await allso for pausing an asynchronous function untill this function is completed
